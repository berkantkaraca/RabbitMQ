...
await bus.StartAsync(); // publisher response dinleyeceği için start edilmeli
...
while (true)
{
    ...
    // Yapılan her request için ayrı bir response alınır. GetResponse requesti yapıp response gelene kadar bekler. Response gelince diğer requesti yapar.
